...
public class SwerveSetpointGenerator {
    ...
    /**
     * Find the root of the generic 2D parametric function 'func' using the regula falsi technique. This is a pretty
     * naive way to do root finding, but it's usually faster than simple bisection while being robust in ways that e.g.
     * the Newton-Raphson method isn't.
    ...
    public SwerveSetpoint generateSetpoint(
        ...
        if (all_modules_should_flip
                && !KinematicsUtil.toTwist2d(prevSetpoint.chassisSpeeds).equals(GeometryUtil.kTwistIdentity)
